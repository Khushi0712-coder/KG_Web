  ...
  return (
    <section className="cart-section py-5 bg-light">
        ...
        {cart.length === 0 ? (
          ...
          <div className="row g-4">
            ...
            <div className="col-lg-8">
              <div className="bg-white rounded-4 shadow-lg p-4">
                {cart.map((item) => (
                  <div key={item.id} className="cart-item py-3 border-bottom">
                    <div className="d-flex align-items-center gap-3 flex-grow-1">
                      <img
                        src={item.img}
                        alt={item.name}
                    ...
                    {/* Qty + Remove desktop view */}
                    <div className="cart-actions d-flex align-items-center gap-2 mt-2 mt-md-0">
                      <button
                        className="btn btn-outline-dark btn-sm px-3 fs-5"
                        onClick={() => decreaseQty(item.id)}
                      >
      ...
      <Checkout
        ...
        nextStep={nextStep}
        prevStep={prevStep}
        amount={total} // ✅ Pass total amount from cart
      />
    </section>
  );
};
